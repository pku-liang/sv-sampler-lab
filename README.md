...
|测试文件|分值|要求|
|-------|----|----|
|basic_part|70|运行10次，每次均能在1min内完成随机解生成|
|opt1|6|运行10次，运行时间的中位数小于20s|
|opt2|10|运行10次，每次均能在30s内完成随机解生成|
|opt3|7|运行10次，至少9次能在1min内完成随机解生成|
|opt4|7|运行10次，每次都能在30s内完成随机解生成|
